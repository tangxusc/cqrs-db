...
//}
//
//func (s *testQuery) Match(query string) (bool, error) {
//	return strings.Contains(query, "some_table_name"), nil
//}
//
//func (s *testQuery) Handler(query string, handler *db.ConnHandler) (*mysql.Result, error) {
